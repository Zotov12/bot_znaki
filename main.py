...
key_znak: KeyboardButton = types.KeyboardButton(text='Знаки зодиака',web_app= web_app)
...
#keyboard.add('Знаки зодиака')
DISC = {
    '1': 'Благоприятными для Овнов в этот день будут физические упражнения, развлечения и активный отдых. Звезды ',
